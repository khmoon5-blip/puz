...
namespace SweetSugar.Scripts.System.Combiner
{
    ...
    public class BonusItemCombiner
    {
        ...
        private void FillPatterns()
        {
            ...
            var bonusCombineList = Resources.LoadAll<ItemCombineBehaviour>("Items");
        ...
        public ItemsTypes GetBonusCombine(ItemTemplate[] itemsFromField, out ItemTemplate[] foundItems, ItemsTypes prioritiseItem = ItemsTypes.NONE)
        {
        ...
        public Matrix SimplifyArray(ItemTemplate[] array)
        {
        ...
        public ItemTemplate[] ConvertCombine(Combine combine)
        {
        ...
        public void Show2DArray(ItemTemplate[] array, string name = "", bool showNow = false)
        {
